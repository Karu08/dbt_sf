...
GRANT IMPORTED PRIVILEGES ON DATABASE CEIC_WORLD_MACRO_ECONOMIC_DATA TO ROLE dbt_hol_role_{{env}};
GRANT IMPORTED PRIVILEGES ON DATABASE SNOWFLAKE_PUBLIC_DATA_FOREIGN_EXCHANGE_RATES TO ROLE dbt_hol_role_{{env}};
